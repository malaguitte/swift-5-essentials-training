...
// 1
var shopItemsArray : [String] = ["Shield", "Sword", "Potion"];
print(shopItemsArray);
var shopItemsDictionary : [String : Int] = [
    shopItemsArray[0] : 100,
    shopItemsArray[1]: 200,
    shopItemsArray[2]: 50,
    "Bag": 80
];
...
shopItemsArray.contains("Bag");

// 3
//shopItemsArray.append("Bag");
shopItemsArray.insert("Bag", at: 1);
print(shopItemsArray);
shopItemsArray.contains("Bag");

// 4
var selectedItem : String = shopItemsArray[2];
print(selectedItem);
...
// 6
var fullArmorSet : Set<String> = ["Helmet", "Shoulder Protection", "Pants", "Boots"];
var currentArmorSet : Set = ["Shoulder Protection", "Pants"];

// 7
var missingArmorSet : Set = fullArmorSet.subtracting(currentArmorSet);
print(missingArmorSet);

// 8
var armorPieceTuple = (name: "Golden Helmet", cost: 800, canEquip: true);
